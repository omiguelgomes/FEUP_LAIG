...
class MyCylinderBody extends CGFobject {
    ...
    initBuffers() {
        ...
        for (var i = 0; i < this.slices; i++) {
            ...
            this.vertices.push(cosAng * this.top, this.height, -senAng * this.top);
            this.texCoords.push(0, 0);
            this.vertices.push(cosAng_Alpha * this.top, this.height, -senAng_Alpha * this.top); //pontos topo c/ y=1
